...
const services = [
  ...
  { img: 'https://images.unsplash.com/photo-1512290923902-8a9f81dc236c?w=600&q=85', t: 'Under Eye Revitalisation', b: 'Dark circles, hollowness, tiredness — visibly and beautifully refreshed.', p: 'From £380' },
  ...
  { img: '/assets/face.png', t: 'Periorbital Rejuvenation', b: 'Target fine lines, crepiness and pigmentation around the delicate eye area.', p: 'From £350' },
  ...
  { img: '/assets/hair.png', t: 'Hair Transplant Enhancement', b: 'PRP applied post-transplant to accelerate graft survival and maximise density results.', p: 'From £550' },
  ...
  { img: '/assets/face.png', t: 'Vampire Facial®', b: 'PRP combined with microneedling for maximum collagen stimulus and absorption.', p: 'From £650' },
  ...
  { img: 'https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?w=600&q=85', t: 'PRP + Fat Grafting (Lipofilling)', b: 'PRP enriches fat grafts to improve survival, integration and long-term volume retention.', p: 'From £900' },
];
        ...
        <div className="serv-grid">
          ...
          <FadeIn style={{ display: 'contents' }}>
            <div className="sv sv-wide">
              <div className="sv-img-wrap">
                <img className="sv-img" src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=600&q=85" alt="Post Surgical PRP" />
              </div>
          ...
          <FadeIn delay={0.36} style={{ display: 'contents' }}>
            <div className="sv featured sv-featured-full">
              <div className="sv-img-wrap">
                <img className="sv-img" src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=1400&q=85" alt="Total Renewal Programme" />
              </div>
              <div className="sv-body">
